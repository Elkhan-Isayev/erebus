...
| **Compression** | **gzip, Snappy, LZ4 and zstd**, read and write. kafkajs ships gzip alone, and a Snappy topic otherwise shows nothing at all; the codecs here are pure JavaScript and WebAssembly, so there is still no native module in the build. |
